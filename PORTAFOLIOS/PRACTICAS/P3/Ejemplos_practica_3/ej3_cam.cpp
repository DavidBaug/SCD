...
// Atributos
#define camarero  10 // Es el numero del proceso [0,1,2...10]. 11 procesos
#define soltar     0
#define coger      1
#define sentarse   2
#define levantarse 3
...
void Filosofo(int id, int nprocesos)
{
    ...
    while (true)
    {
        ...
        cout << MAGENTA << "Filosofo " << id << " solicita sentarse " << BLACK  << endl << flush;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        cout << YELLOW << "Filosofo " << id << " solicita tenedor izq. " << izq << BLACK << endl << flush;
        MPI_Ssend(NULL, 0, MPI_INT, izq, coger, MPI_COMM_WORLD);


        // solicita tenedor derecho
        cout << BLUE << "Filosofo " << id << " solicita tenedor der. " << der << BLACK << endl << flush;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        cout << CYAN << "Filosofo " << id << " suelta tenedor der. " << der << BLACK << endl << flush;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        cout << WHITE << "Filosofo " << id << " se levanta " << BLACK  << endl << flush;
...
void Tenedor(int id, int nprocesos)
{
    ...
    while (true)
    {
        ...
        cout << WHITE << "  Ten. " << id << " recibe petic. de " << Filo << BLACK << endl << flush;

        // Espera a que el filosofo suelte el tenedor...
        MPI_Recv(&Filo, 1, MPI_INT, Filo, soltar, MPI_COMM_WORLD, &status);
        cout << WHITE << "  Ten. " << id << " recibe liberac. de " << Filo << BLACK << endl << flush;
    }
}
...
void Camarero(int id, int nprocesos)
{
    ...
    while (true)
    {
        ...
        //    MPI_Send( NULL, 0, MPI_INT, buf, sentarse, MPI_COMM_WORLD);
            cout << GREEN << "       Filosofo " << buf << " se sienta. Hay " << filo_sentados << " filosofos sentados. " << endl << flush;
        ...
        if (status.MPI_TAG == levantarse) // Se levanta
        {
            ...
            filo_sentados--;
            cout << GREEN << "       Filosofo " << buf << " se levanta. Hay " << filo_sentados << " filosofos sentados.  " << endl << flush;
